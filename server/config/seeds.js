...
db.once('open', async () => {
  ...
  const products = await Product.collection.insertMany([
    {
      name: 'Tin of Cookies',
      description:
    ...
    {
      name: 'Spinning Top',
      category: categories.insertedIds[4],
  ...
  await User.create({
    ...
    orders: [
      {
        products: [products.insertedIds[0], products.insertedIds[0], products.insertedIds[1]]
      }
    ]
  });
